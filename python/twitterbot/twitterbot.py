    ...
    for mention in reversed(mentions): #reversed as we read through the oldest tweets first
        ...
        if '#meteorfinder' in mention.full_text.lower():
            ...
            try:
                ...
                api.update_status('@' + mention.user.screen_name + ' The closest known meteor site to you is called The {} Meteor which landed in {} in {}. Go check it out!'.format(closest_meteor_name, closest_location, closest_year) + maps_link, mention.id)
            except:
